...
if ~isnumeric(filename_tdms)
    ...
    assignin('base','U_B',Spannung_EM_V');
    assignin('base','i_A',Strom_EM_A');
    assignin('base','n_S',Drehzahl_U_min_TTL');
    
    clear Spannung_EM_V Strom_EM_A Drehzahl_U_min Drehzahl_U_min_TTL Infos
end
