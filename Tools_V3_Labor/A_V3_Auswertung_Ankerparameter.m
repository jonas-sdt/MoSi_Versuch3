...
if ui_data_path_on == 1
    data_path = uigetdir('../Daten','Pfad der Messdateien auswählen');
else
    data_path = '../Daten';
end
...
cd(data_path)
[filename_tdms,pathname_tdms] = uigetfile({'*.tdms'},'TDMS-Messdatenfiles für Ermittlung Ankerparameter auswählen','MultiSelect','on');
cd(ActPath)
